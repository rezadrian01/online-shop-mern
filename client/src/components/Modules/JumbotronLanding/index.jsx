...
import { LIST_JUMBOTRON_IMAGES_250_80, LIST_JUMBOTRON_IMAGES_500_150, LIST_JUMBOTRON_IMAGES_800_300 } from '@/constants/listJumbotronImages'
            ...
            <div className='grid grid-cols-6'>
                <div className=' col-span-2 lg:col-span-1 border-r-2 border-r-stone-200 flex flex-col gap-3 pt-4'>
                    <EachUtils of={LIST_JUMBOTRON_CATEGORIES} render={(item, index) => {
                        return <a className='font-semibold' href={item.url}>{item.title}</a>
                    }} />
                </div>
                <div className='hidden lg:block col-span-5 py-4 px-2'>
                    <Carousel images={LIST_JUMBOTRON_IMAGES_800_300} />
                </div>
